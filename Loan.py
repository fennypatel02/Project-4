...
import pickle
import joblib
model = pickle.load(open('Forest.pkl'))
app = Flask(__name__)
@app.route('/')
...
def prediction():
	...
	try:
		...
		if (ans==1):
			print("Congratulations! You have a high chance on getting approved for this Loan.")
		else:
			print("Unfortunately you may not qualify for this loan. Change the loan amount and loan term and try again.")
